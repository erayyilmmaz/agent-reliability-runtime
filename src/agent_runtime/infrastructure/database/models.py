...
class SecurityAuditEvent(Base):
    ...
    target_run_id: Mapped[uuid.UUID | None] = mapped_column(Uuid(as_uuid=True), nullable=True)
...
class TenantKey(Base):
    """Mutable key registry; tombstones must never be recreated automatically."""
    ...
    last_encrypted_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
